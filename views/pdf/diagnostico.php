...
// Cabecera de página
    function Header() {
      ...
      $this->Image('views/assets/img/logoclinica.jpg', 160, 3, 50); //posicion de la imagen x, y z
        ...
        $this->cell(0, 10, utf8_decode("Atenciones por Diagnóstico"), 0, 1); //ancho, largo, contenido,salto de linea
...
$pdf->Cell(40, 8, utf8_decode("Diagnóstico"), 'B', 0, 'C', 1); //ancho, largo, contenido,borde,salto de linea,alineado, color
...
while ($atencion = $atenciones->fetch_object()) {
    $diagnostico= substr(utf8_decode($atencion->diagnostico), 0, 30);
    ...
    $pdf->Cell(40, 8, $diagnostico, 'B', 0, 'C', 1); //ancho, largo, contenido,borde,salto de linea,alineado, color
    $pdf->Cell(50, 8, $departamento, 'B', 0, 'C', 1); //ancho, largo, contenido,borde,salto de linea,alineado, color
    $pdf->Cell(50, 8, $ciudad, 'B', 0, 'C', 1); //ancho, largo, contenido,borde,salto de linea,alineado, color
