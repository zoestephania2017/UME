...
// Cabecera de página
  ...
  //      $this->Image('views/assets/img/logo.png', 10, 16, 30); //posicion de la imagen x, y z
        ...
        $this->cell(0, 10, "Atenciones por Sala", 0, 1); //ancho, largo, contenido,salto de linea
...
$pdf->Cell(40, 8, "Sala", 'B', 0, 'C', 1); //ancho, largo, contenido,borde,salto de linea,alineado, color
...
while ($atencion = $atenciones->fetch_object()) {
    $sala = substr(utf8_decode($atencion->sala), 0, 30);
