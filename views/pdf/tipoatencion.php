...
// Cabecera de página
    function Header() {
      ...
      //  $this->Image('views/assets/img/logo.png', 10, 16, 30); //posicion de la imagen x, y z
        ...
        $this->cell(0, 10, "Atenciones por Atencion Brindada", 0, 1); //ancho, largo, contenido,salto de linea
...
$pdf->Cell(40, 8, "Atencion Brindada", 'B', 0, 'C', 1); //ancho, largo, contenido,borde,salto de linea,alineado, color
$pdf->Cell(50, 8, "Departamento", 'B', 0, 'C', 1); //ancho, largo, contenido,borde,salto de linea,alineado, color
$pdf->Cell(50, 8, "Ciudad", 'B', 0, 'C', 1); //ancho, largo, contenido,borde,salto de linea,alineado, color
...
while ($atencion = $atenciones->fetch_object()) {
    $atencion_brindada = substr(utf8_decode($atencion->atencion), 0, 30);
    ...
    $pdf->Cell(40, 8, $atencion_brindada, 'B', 0, 'C', 1); //ancho, largo, contenido,borde,salto de linea,alineado, color
    $pdf->Cell(50, 8, $departamento, 'B', 0, 'C', 1); //ancho, largo, contenido,borde,salto de linea,alineado, color
    $pdf->Cell(50, 8, $ciudad, 'B', 0, 'C', 1); //ancho, largo, contenido,borde,salto de linea,alineado, color
