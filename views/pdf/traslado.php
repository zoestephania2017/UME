...
// Cabecera de página
    function Header() {
     ...
     //   $this->Image('views/assets/img/logo.png', 10, 16, 30); //posicion de la imagen x, y z
        ...
        $this->cell(0, 10, "Atenciones por Traslado", 0, 1); //ancho, largo, contenido,salto de linea
...
$pdf->Cell(40, 8, "Traslado", 'B', 0, 'C', 1); //ancho, largo, contenido,borde,salto de linea,alineado, color
...
while ($atencion = $atenciones->fetch_object()) {
    $traslado = substr(utf8_decode($atencion->traslado), 0, 30);
