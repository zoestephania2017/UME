<?php if ($_SESSION['usuario']->id_rol == "1" || $_SESSION['usuario']->id_rol == "2"): ?>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Registro de Nuevos Conductores</li>
                </ol>
            </nav>
        </div>
        ...
        <section class="section">
            ...
            <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Ingrese los Datos del Nuevo Conductor:</h5>

                <div class="card">
                    <div class="card-body">
                        <?php if (isset($_SESSION['registrar']) && $_SESSION['registrar'] == 'completado'): ?>
                            <script>
                                mensaje('Conductor', 'Regitrado');
                            </script>
