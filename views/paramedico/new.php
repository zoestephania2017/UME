<?php if ($_SESSION['usuario']->id_rol == "1" || $_SESSION['usuario']->id_rol == "2"): ?>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Nuevo Paramédico</h1>
            <nav>
                <ol class="breadcrumb">


                    <li class="breadcrumb-item active">Registro de Nuevos Paramédicos</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Ingrese los Datos del Nuevo Paramedico:</h5>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="<?= base_url ?>paramedico/guardar" method="POST">
                            <div class="col-md-4">
