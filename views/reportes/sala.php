...
<?php if ($_SESSION['usuario']->id_rol == "1" || $_SESSION['usuario']->id_rol == "2"): ?>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Atenciones por Sala </h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active">Reporte de Atenciones por Sala</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="card">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" target="_blank" action="<?= base_url ?>reporte/salapdf" method="POST">
