...
<?php if ($_SESSION['usuario']->id_rol == "1" || $_SESSION['usuario']->id_rol == "2"): ?>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Atenciones por Traslado </h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active">Reporte de Atenciones por Traslado</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="card">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" target="_blank" action="<?= base_url ?>reporte/trasladopdf" method="POST">
                     ...
                     <div class="col-md-4">
                            ...
                            <select class="form-select" id="traslado" name="traslado"  required>
                                ...
                                <option value="Por Otra Ambulancia">Ambulancia Particular</option>
                                <option value="Por Policia Nacional">Policia Nacional</option>
                                <option value="Por Policia Militar">Policia Militar</option>
                                <option value="Por Policia Bomberos">Policia Bomberos</option>
