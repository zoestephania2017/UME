...
<?php if ($_SESSION['usuario']->id_rol == "1" || $_SESSION['usuario']->id_rol == "2"): ?>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Modificación de Datos de Punto Estrategico</h1>
            <nav>
                <ol class="breadcrumb">


                    <li class="breadcrumb-item active">Ingrese los Datos del Punto Estrategico a Modificar</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="<?= base_url ?>puntoestrategico/guardar" method="POST">

                            <input type="number" class="form-control" id="id"  name="id" value="<?= $pe->id ?>" hidden>

                            <div class="col-md-4">
                                <label for="descripcion" class="form-label">Nombre del Punto Estrategico:</label>
                                <input type="text" class="form-control" id="descripcion"  name="descripcion" value="<?= $pe->descripcion ?>" required>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" id="ciudad"  name="ciudad"  required>
                                    ...
                                    <?php while ($ciudad = $ciudades->fetch_object()): ?> 
                                        <option value="<?= $ciudad->id ?>" <?= $pe->id_ciudad == $ciudad->id ? 'selected' : '' ?> >--<?= $ciudad->descripcion ?>--</option>
                                    <?php endwhile; ?> 
                                </select>
                            </div>
                            ...
                            <div class="col-12">
                            <button class="btn btn-warning rounded-pill" onclick="return confirm('¿Estas seguro que desea modificar el Punto Estrategico?')" type="su bmit">Modificar Dato</button></center> 
                            </div>
                        </form>
