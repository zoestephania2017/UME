...
<?php if ($_SESSION['usuario']->id_rol == "1" || $_SESSION['usuario']->id_rol == "2"): ?>
    ...
    <?php if (isset($_SESSION['registrar']) && $_SESSION['registrar'] == 'completado'): ?>
        <script>
            mensaje('Punto Estrategico', 'Regitrada');
        </script>
    ...
    <main id="main" class="main">
        ...
        <section class="section">
            ...
            <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Ingrese los Datos del Punto Estrategico:</h5>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="<?= base_url ?>puntoestrategico/guardar" method="POST">
                            ...
                            <div class="col-12">
                            <button class="btn btn-primary rounded-pill" onclick="return confirm('¿Esta Seguro que Desea Guardar Este Punto Estrategico?')" type="submit" >Guardar Registro</button></center> 
                            </div>
                        </form>
